    ...
    do
        case $opt in
            ...
            "UpdateWemx")
                ...
                ;;
			"UpdateTinyMC")
                echo "Updating TinyMC Confirmed! | Preparing..."
				sleep 5s
                tinymc_update
                ;;
            "RenewCert")
...
echo "Please enter the new TinyMC API Key:"
read new_key
# Define the directory
directory="/var/www/wemx/Modules/Tickets/Resources/views/"
...
cd "$directory" || { echo "Error: Unable to change to directory $directory... Is wemx even installed?"; exit 1; }
# Find and replace the key in all files
find . -type f -exec sed -i 's|https://cdn\.tiny\.cloud/1/[^/]*/tinymce/[0-9]/tinymce\.min\.js|https://cdn.tiny.cloud/1/'"$new_key"'/tinymce/7/tinymce.min.js|g' {} +
echo "Replacement complete. The key has been updated."
success "Update Completed. Check for Errors Above!"
echo "============================================================================"
echo "This was the entire TinyMC Updater!"
echo "Returning to Main Menu... Please Wait..."
echo "============================================================================"
sleep 5s
clear
echo "============================================================================"
success "Successfully ran the TinyMC Updater Script."
echo "============================================================================"
show_menu
}
